...
export function ExpenseTracking() {
  ...
  return (
    <div className="space-y-6">
        ...
        <Dialog open={isAddExpenseOpen} onOpenChange={setIsAddExpenseOpen}>
          ...
          <DialogContent className="max-w-2xl">
            <DialogHeader>
              ...
              <DialogDescription>
                Record a new expense and assign it to a friend.
              </DialogDescription>
            </DialogHeader>
            <div className="grid gap-4 py-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="grid gap-2">
                  ...
                  <Select
                    ...
                    onValueChange={value =>
                      setNewExpense({ ...newExpense, friendId: value })
                    }>
                    <SelectTrigger>
                ...
                <div className="grid gap-2">
                  ...
                  <Select
                    ...
                    onValueChange={value =>
                      setNewExpense({ ...newExpense, creditCardId: value })
                    }>
                    <SelectTrigger>
              ...
              {/* ... existing code for category, tax, interest, EMI fields ... */}
              ...
              <div className="flex items-center space-x-2">
                <Checkbox
                  ...
                  onCheckedChange={checked =>
                    setNewExpense({ ...newExpense, isEMI: !!checked })
                  }
                />
      ...
      {/* ... existing code for expense list display ... */}
        ...
        {expenses.length > 0 ? (
          expenses
            ...
            .map(expense => {
              ...
              const totalAmount =
                expense.amount + (expense.tax || 0) + (expense.interest || 0);
                        ...
                        {expense.isEMI && expense.emiDetails && (
                          <div className="mt-3 p-3 bg-muted rounded-lg">
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-4 gap-2 text-sm text-muted-foreground">
                              <div>
                                Monthly: ₹
                                {expense.emiDetails.monthlyAmount.toLocaleString()}
                              </div>
                              <div>
                                Remaining: {expense.emiDetails.remainingMonths}{' '}
                                months
                              </div>
                              <div>
                                Total: ₹
                                {expense.emiDetails.totalAmount.toLocaleString()}
                              </div>
                              <div>
                                Rate: {expense.emiDetails.interestRate}%
                              </div>
                            </div>
                          </div>
                        )}
